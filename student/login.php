...
<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css" integrity="sha384-wvfXpqpZZVQGK6TAh5PVlGOfQNHSoD2xbE+QkPxCAFlNEevoEH3Sl0sibVcOQVnN" crossorigin="anonymous">
    <title>Admin Login |  AIUB</title>
  </head>
  <body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <a class="navbar-brand" href="#" style="font-size:30px;"><strong>AIUB</strong></a>
  ...
  <img class="card-img-top mx-auto" src="https://allresultbd.org/wp-content/uploads/2018/09/American-International-University-Bangladesh-AIUB-logo.png" style="width: 60%; " alt="Card image cap">
  <div class="card-body">
