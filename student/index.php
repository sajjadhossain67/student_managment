...
<body>
	...
	<div class="container">
<a href="https://lexacademy.in" target="_blank"><img src="https://allresultbd.org/wp-content/uploads/2018/09/American-International-University-Bangladesh-AIUB-logo.png" alt="" width="350px" ></a><br><hr>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
		...
		<center><img src="https://allresultbd.org/wp-content/uploads/2018/09/American-International-University-Bangladesh-AIUB-logo.png" width="300px" height="80px" alt=""></center>
...
<select name="state" class="form-control">
  ...
  <option value="Division">Division</option>
									...
									<option value="Mymansingh">Maymansingh</option>
  ...
  <div class='modal-dialog'>
    ...
    <div class='modal-content'>
      ...
      <div class='modal-body'>
		...
		<div class='form-group col-md-6'>
		<label for='nidno'>NID No.</label>
		<input type='text' class='form-control' name='user_nid' maxlength='12' placeholder='Enter 12-digit NID no. ' value='$nid'>
		</div>
		</div>
